...
const BASE_SPEED=8
const ACCELERATION_FACTOR=6  # change me also in the global class
const PLAYER_STRAIGHT_SPEED=BASE_SPEED*ACCELERATION_FACTOR
const PLAYER_CATCH_SPEED=BASE_SPEED*ACCELERATION_FACTOR*1.5
const PLAYER_STROLL_SPEED=BASE_SPEED*ACCELERATION_FACTOR*0.6
const PLAYER_TRADE_TIME=10.0/ACCELERATION_FACTOR
const PLAYER_BUY_TIME=7.0/ACCELERATION_FACTOR
const PLAYER_DODGE_TIME=1.0
const PLAYER_WAIT_TIME=2.0
const PLAYER_COLLECT_TIME=5.0/ACCELERATION_FACTOR
